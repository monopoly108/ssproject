...
_RES_FILE_NM = "C:\\eBEST\\xingAPI\\Res\\tmpnm.res"
...
def request_stk_prc(gicode="", res_id="t1102"):
    """
    ...
    query = win32com.client.DispatchWithEvents(_QUERY_NM,
                                               RequestSessionEventHandler)
    query.ResFileName = _RES_FILE_NM.replace("tmpnm", res_id)
    query.SetFieldData(_IN_BLOCK.replace("tmpnm", res_id), "shcode",
                       0, gicode[1:])
    query.Request(0)
    ...
    name = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "hname", 0)
    price = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                               "price", 0)
    volume = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                                "volume", 0)
...
def request_stk_quote(gicode="", res_id="t1101"):
    """
    ...
    offerrem1 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem1", 0)
    offerho1 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho1", 0)
    bidho1 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho1", 0)
    bidrem1 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem1", 0)

    offerrem2 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem2", 0)
    offerho2 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho2", 0)
    bidho2 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho2", 0)
    bidrem2 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem2", 0)

    offerrem3 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem3", 0)
    offerho3 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho3", 0)
    bidho3 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho3", 0)
    bidrem3 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem3", 0)

    offerrem4 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem4", 0)
    offerho4 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho4", 0)
    bidho4 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho4", 0)
    bidrem4 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem4", 0)

    offerrem5 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem5", 0)
    offerho5 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho5", 0)
    bidho5 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho5", 0)
    bidrem5 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem5", 0)

    offerrem6 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem6", 0)
    offerho6 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho6", 0)
    bidho6 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho6", 0)
    bidrem6 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem6", 0)

    offerrem7 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem7", 0)
    offerho7 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho7", 0)
    bidho7 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho7", 0)
    bidrem7 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem7", 0)

    offerrem8 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem8", 0)
    offerho8 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho8", 0)
    bidho8 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho8", 0)
    bidrem8 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem8", 0)

    offerrem9 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem9", 0)
    offerho9 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho9", 0)
    bidho9 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho9", 0)
    bidrem9 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem9", 0)

    offerrem10 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerrem10", 0)
    offerho10 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "offerho10", 0)
    bidho10 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidho10", 0)
    bidrem10 = query.GetFieldData(_OUT_BLOCK.replace("tmpnm", res_id),
                              "bidrem10", 0)
...
def request2_account_trade_result(account_num="", order_pw="",
    ...
    query = win32com.client.DispatchWithEvents(_QUERY_NM,
                                               RequestSessionEventHandler)
    query.ResFileName = _RES_FILE_NM.replace("tmpnm", res_id)
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "AcntNo",
                       0, str(account_num))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "InptPwd",
                       0, str(order_pw))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "OrdMktCode"
                       , 0, str(mkt_gb))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "BnsTpCode",
                       0, str(bid_gb))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "ExecYn",
                       0, str(trade_gb))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "OrdDt",
                       0, str(trd_dt))
    query.Request(0)
...
def request2_account_result(account_num="", order_pw="",
    ...
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "AcntNo",
                       0, str(account_num))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "Pwd",
                       0, str(order_pw))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id), "BalCreTp",
                       0, str(balance_gb))
    query.SetFieldData(_IN_BLOCK1.replace("tmpnm", res_id),
